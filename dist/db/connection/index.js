...
var DatabaseManager = /** @class */ (function () {
    ...
    DatabaseManager.prototype.connectToDatabases = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _loop_1, this_1, _i, _a, _b, dbName, uri;
            return __generator(this, function (_c) {
                _loop_1 = function (dbName, uri) {
                    if (!this_1.connections[dbName]) {
                        try {
                            ...
                            this_1.connections[dbName] = connection;
                        }
                        catch (error) {
                            console.error("Failed to connect to ".concat(dbName, ":"), error);
                            throw error;
    ...
    DatabaseManager.prototype.getDatabaseConnection = function (dbName) {
        var connection = this.connections[dbName];
        if (!connection) {
            throw new Error("No connection found for database: ".concat(dbName));
        }
        return connection;
    };
    DatabaseManager.prototype.closeConnections = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, _b, dbName, connection, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _i = 0, _a = Object.entries(this.connections);
                        _c.label = 1;
                    case 1:
