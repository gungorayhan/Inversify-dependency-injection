...
var AuthMiddleware = /** @class */ (function () {
    ...
    AuthMiddleware.prototype.authenticate = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var authHeader, token, user, refreshToken, newTokens, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authService.verifyTokenAndGetUser(token)];
                    case 1:
                        user = _a.sent();
                        if (user) {
                            req.user = user || {};
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [2 /*return*/, res.status(401).json({ message: 'Unauthorized: Invalid or missing tokenn' })];
                    case 5:
                        error_1 = _a.sent();
                        console.log("Authentication Error: ", error_1);
                        return [2 /*return*/, res.status(401).json({ message: 'Unauthorized: Error in authentication' })];
